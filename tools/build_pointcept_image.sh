...
# rotary position embedding and otherwise falls back to plain PyTorch for).
#
#   tools/build_pointcept_image.sh                 # pointrope, tagged pcit-pointcept:latest
#   tools/build_pointcept_image.sh --libs "pointrope pointops2 pointseg"
#
